...
class ReportCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => ReportDetailsSheet.show(context, report),
      child: GlassCard(
        borderRadius: 24.0,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(flex: 2, child: _buildStatItem('Format', report.format, colors)),
                  Expanded(
                    flex: 3,
                  ...
                  Expanded(
                    ...
                    child: _buildStatItem(
                      'ID',
                      report.id.length > 14 ? '${report.id.substring(0, 12)}…' : report.id,
                      colors,
                      isMono: true,
                    ),
                  ),
